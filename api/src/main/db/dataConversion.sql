...
CREATE TABLE "CONV_GRAD_STUDENT"
   (
 ...
 --------------------------------------------------------
   ...
   ALTER TABLE "CONV_GRAD_STUDENT" MODIFY ("FK_GRAD_PROGRAM_CODE" NOT NULL ENABLE);
   ALTER TABLE "CONV_GRAD_STUDENT" MODIFY ("STUDENT_ID" NOT NULL ENABLE);
   ALTER TABLE "CONV_GRAD_STUDENT" ADD CONSTRAINT "CONV_GRAD_STUDENT_PK" PRIMARY KEY ("STUDENT_ID")
   USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
   STORAGE(INITIAL 131072 NEXT 131072 MINEXTENTS 1 MAXEXTENTS 2147483645
   PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
   BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
   TABLESPACE "GRADUATION_DATA"  ENABLE;
   ALTER TABLE "CONV_GRAD_STUDENT" MODIFY ("PEN" NOT NULL ENABLE);
   ALTER TABLE "CONV_GRAD_STUDENT" MODIFY ("CREATED_BY" NOT NULL ENABLE);
   ALTER TABLE "CONV_GRAD_STUDENT" MODIFY ("CREATED_TIMESTAMP" NOT NULL ENABLE);
   ALTER TABLE "CONV_GRAD_STUDENT" MODIFY ("UPDATED_BY" NOT NULL ENABLE);
   ALTER TABLE "CONV_GRAD_STUDENT" MODIFY ("UPDATED_TIMESTAMP" NOT NULL ENABLE);

--------------------------------------------------------
--  DDL for Table GRAD_STUDENT_SPECIAL_PROGRAMS
--------------------------------------------------------

CREATE TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS"
...
ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" MODIFY ("ID" NOT NULL ENABLE);
ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" ADD CONSTRAINT "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS_PK" PRIMARY KEY ("ID")
    USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 131072 NEXT 131072 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "GRADUATION_DATA"  ENABLE;
ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" MODIFY ("FK_GRAD_STUDENT_PEN" NOT NULL ENABLE);
ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" MODIFY ("FK_GRAD_SPECIAL_PROGRAM_ID" NOT NULL ENABLE);
ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" MODIFY ("CREATED_BY" NOT NULL ENABLE);
ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" MODIFY ("CREATED_TIMESTAMP" NOT NULL ENABLE);
ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" MODIFY ("UPDATED_BY" NOT NULL ENABLE);
ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" MODIFY ("UPDATED_TIMESTAMP" NOT NULL ENABLE);
--------------------------------------------------------
--  Ref Constraints for Table GRAD_STUDENT_SPECIAL_PROGRAMS
--------------------------------------------------------

ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" ADD CONSTRAINT "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS_FK1" FOREIGN KEY ("FK_GRAD_STUDENT_STUDENT_ID")
    REFERENCES "CONV_GRAD_STUDENT" ("STUDENT_ID") ENABLE;
ALTER TABLE "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS" ADD CONSTRAINT "CONV_GRAD_STUDENT_SPECIAL_PROGRAMS_FK2" FOREIGN KEY ("FK_GRAD_SPECIAL_PROGRAM_ID")
    REFERENCES "GRAD_SPECIAL_PROGRAM" ("ID") ENABLE;
