...
@Component
public class TranscriptsValidationJobCompletionNotificationListener implements JobExecutionListener {

    private static final Logger LOGGER = LoggerFactory.getLogger(TranscriptsValidationJobCompletionNotificationListener.class);
